...
import lightGCN_model
from snack import data_lightGCN, parameter_setting
import torch
import numpy as np
...
if __name__ == '__main__':
    ...
    data = data_lightGCN.Data(path, batch_size)
    ...
    net = lightGCN_model.LightGCN(data.n_user, data.n_item, norm_adj, device, parser_lightgcn)
    net = net.to(device)
    print(net.device)
